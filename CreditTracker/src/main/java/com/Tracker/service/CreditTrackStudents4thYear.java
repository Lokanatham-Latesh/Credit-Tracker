...
@Service
public class CreditTrackStudents4thYear {
	...
	private SubjectRepoCIVIL subjectRepoCIVIL;
	 ...
	 private static final Map<String, Integer> TOTAL_CREDITS = Map.of(
		...
		public List<Map<String, Object>> getCIVIL4thYearBasketCreditsByRegdNo(String regdNo) {
		    // Get the filtered credit data
		    List<CreditData4thYear> creditDataList = get4thYearCreditDataByRegdNo(regdNo);
		...
		public List<Map<String, Object>> getMECH4thYearBasketCreditsByRegdNo(String regdNo) {
		    // Get the filtered credit data
		    List<CreditData4thYear> creditDataList = get4thYearCreditDataByRegdNo(regdNo);
		    if (creditDataList.isEmpty()) {
		        // Return a list with a message indicating no data was found
		...
		public List<Map<String, Object>> getEEE4thYearBasketCreditsByRegdNo(String regdNo) {
		    // Get the filtered credit data
		    List<CreditData4thYear> creditDataList = get4thYearCreditDataByRegdNo(regdNo);
		    if (creditDataList.isEmpty()) {
		        // Return a list with a message indicating no data was found
		...
		public List<Map<String, Object>> getECE4thYearBasketCreditsByRegdNo(String regdNo) {
		    // Get the filtered credit data
		    List<CreditData4thYear> creditDataList = get4thYearCreditDataByRegdNo(regdNo);
		    if (creditDataList.isEmpty()) {
		        // Return a list with a message indicating no data was found
		...
		public List<Map<String, Object>> getCSE4thYearBasketCreditsByRegdNo(String regdNo) {
		    // Get the filtered credit data
		    List<CreditData4thYear> creditDataList = get4thYearCreditDataByRegdNo(regdNo);
		    if (creditDataList.isEmpty()) {
		        // Return a list with a message indicating no data was found
	...
	public List<CreditData4thYear> get4thYearCreditDataByRegdNo(String regdNo) {
	    // Fetch data from CreditData1stYearRepo for the given registration number
		
	    return creditData4thYearRepo.findAllByRegdNo(regdNo);
	}
