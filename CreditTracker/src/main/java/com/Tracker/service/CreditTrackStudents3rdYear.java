...
@Service
public class CreditTrackStudents3rdYear {
	...
	public List<Map<String, Object>> getCSE3rdYearBasketCreditsByRegdNo(String regdNo) {
	    // Get the filtered credit data
	    List<CreditData3rdYear> creditDataList = get3rdYearCreditDataByRegdNo(regdNo);
	...
	public List<Map<String, Object>> getECE3rdYearBasketCreditsByRegdNo(String regdNo) {
	    // Get the filtered credit data
	    List<CreditData3rdYear> creditDataList = get3rdYearCreditDataByRegdNo(regdNo);
	    if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
	...
	public List<Map<String, Object>> getEEE3rdYearBasketCreditsByRegdNo(String regdNo) {
	    // Get the filtered credit data
	    List<CreditData3rdYear> creditDataList = get3rdYearCreditDataByRegdNo(regdNo);
	    if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
	...
	public List<Map<String, Object>> getMECH3rdYearBasketCreditsByRegdNo(String regdNo) {
	    // Get the filtered credit data
	    List<CreditData3rdYear> creditDataList = get3rdYearCreditDataByRegdNo(regdNo);
	    if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
	...
	public List<Map<String, Object>> getCIVIL3rdYearBasketCreditsByRegdNo(String regdNo) {
	    // Get the filtered credit data
	    List<CreditData3rdYear> creditDataList = get3rdYearCreditDataByRegdNo(regdNo);
	    if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
...
public List<CreditData3rdYear> get3rdYearCreditDataByRegdNo(String regdNo) {
    // Fetch data from CreditData1stYearRepo for the given registration number
	
    return creditData3rdYearRepo.findAllByRegdNo(regdNo);
}
