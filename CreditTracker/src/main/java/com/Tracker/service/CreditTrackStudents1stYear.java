...
import com.Tracker.CreditRepositrory.*;
...
@Service
public class CreditTrackStudents1stYear {
    ...
    public List<Map<String, Object>> getCSE1stYearBasketCreditsByRegdNo(String regdNo) {
        // Get the filtered credit data
        List<CreditData1stYear> creditDataList = get1stYearCreditDataByRegdNo(regdNo);
    ...
    public List<CreditData1stYear> get1stYearCreditDataByRegdNo(String regdNo) {
        // Fetch data from CreditData1stYearRepo for the given registration number
        return creditData1stYearRepo.findAllByRegdNo(regdNo);
    }


    public List<Map<String, Object>> getECEE1stYearBasketCreditsByRegdNo(String regdNo) {
        // Get the filtered credit data
        List<CreditData1stYear> creditDataList = get1stYearCreditDataByRegdNo(regdNo);
    ...
    public List<Map<String, Object>> getEEE1stYearBasketCreditsByRegdNo(String regdNo) {
        // Get the filtered credit data
        List<CreditData1stYear> creditDataList = get1stYearCreditDataByRegdNo(regdNo);
        if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
    ...
    public List<Map<String, Object>> getMECH1stYearBasketCreditsByRegdNo(String regdNo) {
        // Get the filtered credit data
        List<CreditData1stYear> creditDataList = get1stYearCreditDataByRegdNo(regdNo);
        if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
    ...
    public List<Map<String, Object>> getCIVIL1stYearBasketCreditsByRegdNo(String regdNo) {
        // Get the filtered credit data
        List<CreditData1stYear> creditDataList = get1stYearCreditDataByRegdNo(regdNo);
        if (creditDataList.isEmpty()) {
	        // Return a list with a message indicating no data was found
